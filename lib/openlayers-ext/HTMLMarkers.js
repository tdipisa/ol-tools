...
OpenLayers.Layer.HTMLMarkers = OpenLayers.Class(OpenLayers.Layer.Markers, {
	...
	*/
    ...
    initialize: function(name, options) {
		...
		this.style = options.styleMap.style || this.defaultStyle;
    ...
    parseData: function(ajaxRequest) {
        ...
        for (var i=0, len=features.length; i<len; i++) {
            ...
            var marker = markerFeature.createMarker(label, this.markerClick);
...
OpenLayers.HTMLFeature = OpenLayers.Class(OpenLayers.Feature, {
	...
	/**
	*/
	createMarker: function(label, handler) {
        if (this.lonlat != null && label != null) {
            this.marker = new OpenLayers.Marker.HTMLMarkerLabel(this.lonlat, this.data.icon, label);
